...
class ShuffleNetV2(nn.Module):
    ...
    def __init__(self, ratio=1, in_channels=3, num_classes=10):
        super().__init__()
        if ratio == 0.5:
...
def shufflenetv2(in_channels=3, num_classes=10):
    return ShuffleNetV2(in_channels=in_channels, num_classes=num_classes)
